...
def do_dai_dien_tich():
    ...
    if donvi == 1 and chuyensang == 2:
        ...
        d5 = d4/1000000
        print("kết quả là:", format(d5, '.6f'), "hm")
        
    elif donvi == 3 and chuyensang == 7:
        cls()
        d6 = float(input("nhập đơn vị đo đã có: "))
        d7 = d6/100000000
        print("kết quả là:", format(d7, '.8f'), "km")
        ...
        e9 = e8/1000000
        print("kết quả là:", format(e9, '.6f'), "km")
